...
const Dashboard = () => {
  ...
  <h2 className="text-lg font-semibold mb-4 text-gray-100">
    Sales Analytics
      ...
      <section className="bg-gradient-to-br from-white to-gray-50 p-6 rounded-2xl shadow-lg mb-6 border border-gray-100">
      ...
      bestselling.map((product) => (
        ...
        >
          <img
            ...
            alt={product.title}
            className="rounded-lg mb-3 w-full h-40 object-contain"
