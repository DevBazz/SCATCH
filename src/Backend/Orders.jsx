...
const Orders = () => {
  ...
  return (
    <div className="w-full h-screen bg-gray-50 text-gray-900 p-6 md:p-8 overflow-y-auto">
      {/* Header */}
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          ...
          <div className="relative flex-1 sm:flex-none">
            <input
              ...
              className="w-full bg-white border border-gray-300 rounded px-4 py-2 pl-10 text-gray-900 outline-none focus:ring-2 focus:ring-blue-400"
            />
